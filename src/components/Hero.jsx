...
const Hero = () => {
  return (
    <div className='lg:flex lg:bg-background overflow-x-hidden'>
        <div className='lg:pl-16 lg:bg-background'>
            ...
            <div className='text-center sm:relative sm:mt-10 lg:static lg:-mt-6'>
            <Button classname={`mx-5 px-12 bg-purple text-white lg:text-left`} text={`Stop an animal going hungry or homeless this winter`} />
            </div>
        </div>
